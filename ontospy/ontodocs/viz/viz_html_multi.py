...
class KompleteViz(VizFactory):
    ...
    def _buildTemplates(self):
        ...
        contents = self._renderTemplate(
            ...
            extraContext={"theme": self.theme, "index_page_flag": True},
        )
        ...
        # DASHBOARD
        contents = self._renderTemplate(
            "html-multi/statistics.html", extraContext={"theme": self.theme}
        )
        ...
        contents = self._renderTemplate(
            "html-multi/browser/browser_entities_az.html", extraContext=extra_context
        )
        ...
        if self.ontospy_graph.all_classes:
            ...
            extra_context = {
                ...
                "theme": self.theme,
                "treetype": "classes",
                "treeTable": formatHTML_EntityTreeTable(
                    self.ontospy_graph.ontologyClassTree()
                ),
            }
            contents = self._renderTemplate(
        ...
        if self.ontospy_graph.all_properties:
            ...
            extra_context = {
                ...
                "treetype": "properties",
                "treeTable": formatHTML_EntityTreeTable(
                    self.ontospy_graph.ontologyPropTree()
                ),
            }
            contents = self._renderTemplate(
                "html-multi/browser/browser_entities_tree.html",
        ...
        if self.ontospy_graph.all_shapes:
            ...
            extra_context = {
                ...
                "treetype": "shapes",
                "treeTable": formatHTML_EntityTreeTable(
                    self.ontospy_graph.ontologyShapeTree()
                ),
            }
            contents = self._renderTemplate(
                "html-multi/browser/browser_entities_tree.html",
        ...
        if self.ontospy_graph.all_individuals:
            ...
            extra_context = {
                ...
                "treeTable": formatHTML_EntityTreeTable(
                    self.ontospy_graph.ontologyIndividualsTree()
                ),
            }
            contents = self._renderTemplate(
                "html-multi/browser/browser_entities_tree.html",
...
class KompleteVizMultiModel(KompleteViz):
    ...
    def __init__(
        self, ontospy_graph, title="", theme="", static_url="", output_path_static=""
    ):
        """
        Init
        """
